      ...
      objects: [
        {
          ...
          key: splineKey,
          description:
            'Explore the wonders of splines, including how different functions (i.e. Bezier, Hermite, Catmull-Rom, etc.) generate different curvatures / shapes across customisable paths / polygons.',
        },
        {
          name: 'Eulerian Fluid Simulator',
          key: eulerianKey,
          description:
            'Delve into the nature of gas and fluid propagation by analysing the effects of intersecting sources, obstructions, and more.',
        },
      ],
    },
    {
      ...
      objects: [
        {
          ...
          key: mathConceptKey,
          description:
            'Animations of mathematical concepts from Convolutions, to Fourier Transforms, through to Spline generation. Most of these concepts can be seen practically through the Games and Simulations provided.',
        },
      ],
    },
  ],
